...
//------------------------------------------------------------------------------
  ...
  //----------------------------------------------------------------------------
    ...
    retVal = pictureMask.check("");         XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
  ...
  //----------------------------------------------------------------------------
    ...
    maskVal = pictureMask.setMask("&-")
    XCTAssert(maskVal.errMsg == nil, maskVal.errMsg ?? "")
    retVal = pictureMask.check("A");        XCTAssert(retVal.status == .OkSoFar, retVal.errMsg ?? "")
    retVal = pictureMask.check("A-");       XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("-A");       XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
    retVal = pictureMask.check("AA");       XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
    ...
    retVal = pictureMask.check("A");        XCTAssert(retVal.status == .OkSoFar, retVal.errMsg ?? "")
    retVal = pictureMask.check("A-");       XCTAssert(retVal.status == .OkSoFar, retVal.errMsg ?? "")
    retVal = pictureMask.check("A-B");      XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("A-BC");     XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
  ...
  //----------------------------------------------------------------------------
    ...
    XCTAssert(maskVal.errMsg == nil, maskVal.errMsg ?? "")
    retVal = pictureMask.check("");         XCTAssert(retVal.status == .OkSoFar, retVal.errMsg ?? "")
    retVal = pictureMask.check("R");        XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("G");        XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("B");        XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("RG");       XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
    retVal = pictureMask.check("GB");       XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")

    maskVal = pictureMask.setMask("{Red,Green,Blue}")
    XCTAssert(maskVal.errMsg == nil, maskVal.errMsg ?? "")
    retVal = pictureMask.check("");         XCTAssert(retVal.status == .OkSoFar, retVal.errMsg ?? "")
    retVal = pictureMask.check("R");        XCTAssert(retVal.status == .OkSoFar, retVal.errMsg ?? "")
    retVal = pictureMask.check("Re");       XCTAssert(retVal.status == .OkSoFar, retVal.errMsg ?? "")
    retVal = pictureMask.check("Red");      XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("Redd");     XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
    retVal = pictureMask.check("G");        XCTAssert(retVal.status == .OkSoFar, retVal.errMsg ?? "")
    retVal = pictureMask.check("Gr");       XCTAssert(retVal.status == .OkSoFar, retVal.errMsg ?? "")
    retVal = pictureMask.check("Gree");     XCTAssert(retVal.status == .OkSoFar, retVal.errMsg ?? "")
    retVal = pictureMask.check("Green");    XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("Greenn");   XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
    ...
    retVal = pictureMask.check("Bluee");    XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
}
  ...
  //----------------------------------------------------------------------------
    ...
    retVal = pictureMask.check("A");        XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("A1");       XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
    retVal = pictureMask.check("AA");       XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
  ...
  //----------------------------------------------------------------------------
    ...
    retVal = pictureMask.check("");         XCTAssert(retVal.status == .OkSoFar, retVal.errMsg ?? "")
    retVal = pictureMask.check("123");      XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("123A");     XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("A-123");    XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("A-123A");   XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("1A-123");   XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("1A-123A");  XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("1A-1234");  XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
    retVal = pictureMask.check("12-123A");  XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
  }
  ...
  // Unsigned integer
    ...
    retVal = pictureMask.check("123");      XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("-123");     XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
    retVal = pictureMask.check("ABC");      XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
  }
  ...
  // US Dates
    ...
    maskVal = pictureMask.setMask("#[#]/#[#]/##[##]")
    XCTAssert(maskVal.errMsg == nil, maskVal.errMsg ?? "")
    retVal = pictureMask.check("1/1/01");     XCTAssert(retVal.status == .Ok,    retVal.errMsg ?? "")
    retVal = pictureMask.check("01/1/01");    XCTAssert(retVal.status == .Ok,    retVal.errMsg ?? "")
    retVal = pictureMask.check("1/01/01");    XCTAssert(retVal.status == .Ok,    retVal.errMsg ?? "")
    retVal = pictureMask.check("1/1/2001");   XCTAssert(retVal.status == .Ok,    retVal.errMsg ?? "")
    retVal = pictureMask.check("01/01/2001"); XCTAssert(retVal.status == .Ok,    retVal.errMsg ?? "")
  }
  ...
  // Timestamp
    ...
    retVal = pictureMask.check("01:11:11 XM, 01/01/01");  XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
  }
  ...
  // Timestamp
    ...
    retVal = pictureMask.check("123");      XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("1234");     XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
    retVal = pictureMask.check("12A1");     XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
  }
  ...
  // Capitalized words
    ...
    retVal = pictureMask.check("Hi");                     XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("A B");                    XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("Hi There.");              XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("Hi. How Are You. (Ok)");  XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("Hi. How Are You? (Ok)");  XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
  }
  ...
  // Yes or no
    ...
    retVal = pictureMask.check("Ye");       XCTAssert(retVal.status == .OkSoFar, retVal.errMsg ?? "")
    retVal = pictureMask.check("Yes");      XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("YesA");     XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
    retVal = pictureMask.check("N");        XCTAssert(retVal.status == .OkSoFar, retVal.errMsg ?? "")
    retVal = pictureMask.check("No");       XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("NoA");      XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
  }
...
//  maskVal = pictureMask.setMask("[-]{{#[#][#]{{;,###*[;,###]},*#}[.*#]},.#*#}[E[[+,-]#[#][#]]]")
  ...
  // ICD-9 or -10
    ...
    retVal = pictureMask.check("123.");         XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("123.1");        XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("123.A");        XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("A1B.1");        XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
    retVal = pictureMask.check("1A3.1");        XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
    retVal = pictureMask.check("1234");         XCTAssert(retVal.status == .NotOk,   retVal.errMsg ?? "")
    retVal = pictureMask.check("A1B.A1B2");     XCTAssert(retVal.status == .Ok,      retVal.errMsg ?? "")
  }
}
